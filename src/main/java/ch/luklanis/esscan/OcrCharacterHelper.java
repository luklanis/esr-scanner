...
public class OcrCharacterHelper {
    ...
    public static String getBlacklist(SharedPreferences prefs, String languageCode) {
        if (languageCode.equals("deu")) {
            return prefs.getString(KEY_CHARACTER_BLACKLIST_PAYMENT_SLIP,
    ...
    public static String getWhitelist(SharedPreferences prefs, String languageCode) {
        if (languageCode.equals("deu")) {
            return prefs.getString(KEY_CHARACTER_WHITELIST_PAYMENT_SLIP,
    ...
    public static void setBlacklist(SharedPreferences prefs, String languageCode,
                                    String blacklist) {
        if (languageCode.equals("deu")) {
    ...
    public static void setWhitelist(SharedPreferences prefs, String languageCode,
                                    String whitelist) {
        if (languageCode.equals("deu")) {
